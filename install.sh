...
current_log_retention="$(get_env_value LOG_RETENTION_DAYS "$current_retention")"
...
log_retention_days="$(trim_value "$(ask_value 'Protokoll-Aufbewahrung in Tagen' "$current_log_retention")")"
